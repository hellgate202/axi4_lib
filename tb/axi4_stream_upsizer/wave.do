...
add wave -noupdate /tb_axi4_stream_pkt_frag/DUT/idle_flag
...
add wave -noupdate /tb_axi4_stream_pkt_frag/DUT/buf_done
add wave -noupdate /tb_axi4_stream_pkt_frag/DUT/frag_done
add wave -noupdate /tb_axi4_stream_pkt_frag/DUT/acc_flag
...
WaveRestoreCursors {{Cursor 1} {4602617069 ps} 0}
...
update
WaveRestoreZoom {0 ps} {23954933625 ps}
