...
add wave -noupdate /tb_axi4_stream_upsizer/DUT/pkt_i/tstrb
add wave -noupdate /tb_axi4_stream_upsizer/DUT/pkt_i/tkeep
...
add wave -noupdate /tb_axi4_stream_upsizer/DUT/tkeep_buf
add wave -noupdate /tb_axi4_stream_upsizer/DUT/tstrb_buf
add wave -noupdate /tb_axi4_stream_upsizer/DUT/tdata_buf_shifted
add wave -noupdate /tb_axi4_stream_upsizer/DUT/tkeep_buf_shifted
add wave -noupdate /tb_axi4_stream_upsizer/DUT/tstrb_buf_shifted
...
add wave -noupdate /tb_axi4_stream_upsizer/DUT/bytes_in_buf
...
add wave -noupdate /tb_axi4_stream_upsizer/DUT/rx_bytes
add wave -noupdate /tb_axi4_stream_upsizer/DUT/tx_bytes
...
add wave -noupdate /tb_axi4_stream_upsizer/DUT/pkt_o/tstrb
add wave -noupdate /tb_axi4_stream_upsizer/DUT/pkt_o/tkeep
...
WaveRestoreCursors {{Cursor 1} {22686 ps} 0}
